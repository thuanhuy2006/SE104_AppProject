                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(cartItem.title,
                                        ...
                                        style: const TextStyle(color: etsyText, fontSize: 15, fontWeight: FontWeight.w500)),
                                    const SizedBox(height: 8),
                                    Text(formatCurrency.format(cartItem.price),
                                        style: const TextStyle(color: etsyText, fontWeight: FontWeight.bold)),
                                    const SizedBox(height: 8),
                                    Row(
                                      children: [
                                        // Nút giảm số lượng
                                        ...
                                        Padding(
                                          ...
                                          child: Text('${cartItem.quantity}',
                                              style: const TextStyle(color: etsyText, fontSize: 16, fontWeight: FontWeight.bold)),
                                        ),
                                        // Nút tăng số lượng
                                        InkWell(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(formatCurrency.format(cart.totalAmount),
                              style: const TextStyle(color: etsyText, fontSize: 20, fontWeight: FontWeight.bold)),
                        ],
                      ),
